...
class DecrementVariableNodeWidget extends StatelessWidget {
  final DecrementVariableNode node;

  const DecrementVariableNodeWidget({super.key, required this.node});

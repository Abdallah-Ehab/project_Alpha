...
class AddComponents extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    entityManager.addEntity(EntityType.actors, 'goku', ActorEntity(name: 'goku', tag: 'player', position: Offset.zero, rotation: 0));
    entityManager.activeEntity = entityManager.getActorByName('goku');
